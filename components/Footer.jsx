        ...
        <div className="flexStart flex-1 flex-col">
          <div className="flexCenter cursor-pointer">
            <Image
              ...
              alt="logo"
            />
            <p className="dark:text-white text-nft-black-1 font-semiblod text-lg ml-1">
              NFTverse
            </p>
          </div>
          <p className="font-poppins dark:text-white text-nft-gray-black-1 font-semibold text-base mt-6">Get the latest Updates</p>
          <div className="flexBetween md:w-full minlg:w-557 w-357 mt-6 dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-nft-gray rounded-md">
